...
4. Zenodo archive DOI: to be assigned after `v1.0.2` is archived.
5. Replace DOI placeholders in this file and in the manuscript after the Zenodo archive is updated.
